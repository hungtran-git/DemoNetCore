...
namespace ECDsaDemo
{
    class Program
    {
        ...
        {
            var ecDsaCng = (ECDsa)new ECDsaCng(CngKey.Import(Convert.FromBase64String(privateKey), CngKeyBlobFormat.EccPrivateBlob)) {
        ...
        {
            var ecDsaCng = (ECDsa)new ECDsaCng(CngKey.Import(Convert.FromBase64String(publicKey), CngKeyBlobFormat.EccPublicBlob)) {
                HashAlgorithm = CngAlgorithm.ECDsaP256
            };
            return ecDsaCng;
        }
